    ...
    const skillIconClasses = [
        ...
        "skill-icons--tailwind",
        "skill-icons--git",
        "skill-icons--github",
        "skill-icons--figma",
        "skill-icons--mongodb",
        "skill-icons--postgres",
        "skill-icons--docker",
        "skill-icons--aws",
        "skill-icons--firebase",
        "skill-icons--vue",
        "skill-icons--angular",
        "skill-icons--webpack",
        "skill-icons--sass",
    ...
    honeycomb.forEach((columnSize, columnIndex) => {
        ...
        hexagon.className = `hexagon w-[8vmin] p-[2px] aspect-square relative bg-opacity-35 backdrop-blur-lg cursor-pointer`;
        hexagon.style.backgroundColor = "#f4f2ed25";
        hexagon.dataset.index = cellIndex + 1;

        // Add icon container
        const iconContainer = document.createElement("div");
        iconContainer.className =
            "absolute inset-0 grid place-items-center text-[2.5vmin] filter brightness-50";

        // Create a span with the skill icon class
        const iconSpan = document.createElement("span");
        iconSpan.className = `skill-icon ${allIcons[iconIndex]}`;
